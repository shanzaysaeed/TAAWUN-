    ...
    return (
        ...
        <div className='flex bg-purple-300 w-screen h-screen'>
            ...
            <div className="flex flex-col justify-between w-full">
                ...
                <div className="mb-16 mx-10 w-11/12 h-2/3 rounded">
                    ...
                    <div className='flex flex-row w-3/4 h-40 mt-3 ml-32 justify-center'>
                        <div className='flex flex-col border border-black shadow-md w-40 bg-white rounded-2xl h-40 justify-center mr-28'>
                            <button className='flex flex-col  mx-4  mb-8 justify-center items-center'>
                                ...
                                <button className='bg-[#BFBFBF] text-black rounded-md hover:bg-green-500 w-full h-8 '>Select</button>
                            </button>
                        </div>
                    ...
                    <div className='flex flex-row ml-32 w-3/4 h-40 justify-center mb-2'>
                        <div className='flex flex-col border border-black shadow-md w-40 bg-white rounded-2xl h-40 justify-center mr-28'>
                            <button className='flex flex-col  mx-4  mb-8 justify-center items-center'>
                        ...
                        <div className='flex flex-col border border-black w-40 bg-white rounded-2xl h-40 justify-center'>
                            <button className='flex flex-col  mx-4  mb-8 justify-center items-center'>
                                ...
                                <button className='bg-[#BFBFBF] text-black hover:bg-green-500 rounded-md  w-full h-8'>Select</button>
                            </button>
                    ...
                    <div className='p-3 flex items-start justify-center items-center mt-4 '>
