            ...
            <div className="flex flex-col justify-between w-full">
                ...
                <div className='flex flex-col mb-4 ml-28 '>
                    <div className='flex flex-row mb-2'>
                        <p className='p-2 font-sans text-blaxk font-bold text-xl'>Sign Up Requests</p>
                    </div>
                ...
                <div className="flex flex-col w-2/3 h-fit rounded mb-8 ml-28">
                    <div className='flex flex-row bg-[#F2F2F2] w-full h-28 rounded-md'>
                        ...
                        <div className='flex flex-col h-full w-1/2'>
                            <p className='font-sans text-4xl font-bold mt-4 '>Edhi Foundation</p>
                            <p className='font-sans text-md font-bold'>Registration number: 0123456</p>
                        </div>
                        <div className='p-2 flex flex-row ml-8'>
                            <p className='text-purple-400 font-bold text-2xl mt-6 ml-4'>NGO</p>
                    ...
                    <div className='flex flex-row bg-[#F2F2F2] w-full h-28 rounded-md mt-4'>
                        ...
                        <div className='flex flex-col h-full w-1/2 '>
                            ...
                            <p className='font-sans text-md font-semibold'>Pick-up Address:</p>
                            <p className='font-sans text-md font-semibold'>Contact:</p>
                        </div>
                        <div className='p-2 flex flex-row ml-8'>
                            <p className='text-green-500 font-bold text-2xl mt-6 ml-4'>Rider</p>
                            <button className=''><img src={correct} alt='accept' className='w-7 h-7 ml-10 mb-2'></img></button>
                            <button className=''><img src={d} alt='accept' className='w-7 h-7 ml-10 mb-2'></img></button>
                        </div>
                    </div>
