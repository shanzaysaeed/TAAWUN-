      ...
      <div className="right-box bg-[#D5C6FF] w-3/4 px-10 pt-10 flex flex-col">
        ...
        <div className="form bg-[#F2F2F2] h-full flex flex-col justify-between mt-8 pt-8 px-20 mb-3 pb-3 rounded-xl">
          <div class="p1 flex justify-between border-b border-black pb-4">
            <div class="textStuff flex flex-col">
                ...
                <div class="causes flex items-center justify-between">
                    <p className="h1 text-md my-2 font-bold">Causes:</p>
                    <p className="rounded-lg bg-[#D9D9D9] px-5">Charity</p>
                    <p className="rounded-lg bg-[#D9D9D9] px-5">Social Service</p>
                    <p className="rounded-lg bg-[#D9D9D9] px-5">Poverty Eradication</p>
                </div>
            </div>
          ...
          <div class="textStuff flex flex-col">
                ...
                <div class="causes flex items-center justify-between">
                    Join us in our mission to provide food supplies to those in need during Ramadan. We are looking for volunteers to help us distribute food and collect donations. No experience is necessary, all are welcome. Fill out the form to register and indicate your availability.
                </div>
            </div>
          </div>
